...
<div
                        ...
                        @auth
                            ...
                            @if (setting('user_prompt_library') == null || setting('user_prompt_library'))
                                <div @class([
                                    ...
                                    <x-button
                                        class="lqd-chat-templates-trigger flex size-10 shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full border-heading-foreground/5 text-heading-foreground transition-all max-md:size-auto max-md:bg-transparent max-md:hover:bg-transparent max-md:hover:shadow-none md:border md:hover:border-primary md:hover:bg-primary md:hover:text-primary-foreground lg:size-11"
                                        type="button"
                                        variant="ghost"
                                        size="none"
                            ...
                            <div class="pointer-events-auto flex items-center max-md:flex-col max-md:items-start max-md:gap-4 max-md:pb-4">
                                ...
                                >
                                    <x-slot:trigger
                                        class="lqd-chat-brand-voice-trigger flex size-10 shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full border-heading-foreground/5 p-0 text-heading-foreground transition-all max-md:size-auto max-md:bg-transparent max-md:hover:bg-transparent max-md:hover:shadow-none md:border md:hover:border-primary md:hover:bg-primary md:hover:text-primary-foreground lg:size-11"
                                        variant="none"
                                    >
                                        <x-tabler-focus-2
                                            class="size-[23px]"
                            ...
                            <div
                                ...
                                <x-button
                                    class="lqd-chat-record-trigger flex size-10 shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full text-heading-foreground transition-all max-md:size-auto max-md:bg-transparent max-md:hover:bg-transparent max-md:hover:shadow-none md:border md:hover:border-primary md:hover:bg-primary md:hover:text-primary-foreground lg:size-11 [&.inactive]:hidden"
                                ...
                                <x-button
                                    class="lqd-chat-record-stop-trigger hidden size-10 shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full text-heading-foreground transition-all max-md:size-auto max-md:bg-transparent max-md:hover:bg-transparent max-md:hover:shadow-none md:border md:hover:border-primary md:hover:bg-primary md:hover:text-primary-foreground lg:size-11 [&.active]:flex"
    ...
    @guest
        <p class="relative z-2 mx-auto text-center text-2xs text-heading-foreground/30 max-lg:px-6 lg:mb-0 lg:mt-6 lg:max-w-screen-md">
            {{ __('Login to save your current session. © MagicAI 2025. All rights reserved.') }}
        </p>
    @endguest
</div>
