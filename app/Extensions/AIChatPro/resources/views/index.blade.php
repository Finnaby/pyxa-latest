...
@extends('panel.layout.app', ['disable_tblr' => true, 'layout_wide' => true, 'disable_titlebar' => true, 'disable_footer' => true, 'body_class' => 'lqd-chat-v2'])
...
@section('content')
    ...
    >
        ...
        <div class="grow px-2 md:px-5 lg:px-0">
            <div @class([
                'relative end-0 start-0 top-0 z-40 h-[--header-h] justify-between gap-3 bg-background px-3.5 transition-all md:px-5 lg:fixed lg:start-[--sidebar-w] lg:z-10 xl:px-8',
                ...
                <div class="flex w-5/12 items-center justify-end gap-3.5 max-lg:grow max-sm:gap-2">
                    ...
                    @if ((!$user_is_premium || $app_is_demo) && !auth()->check())
                        <div class="group relative py-4">
                            <x-button
                                class="font-semibold text-heading-foreground max-md:size-[38px] max-md:border max-md:p-0"
                                variant="ghost"
                                hover-variant="primary"
                            >
                            ...
                            <div
                                class="pointer-events-none invisible absolute end-0 top-full z-10 max-h-[calc(100vh-100px)] w-[415px] origin-top-right translate-y-2 scale-95 rounded-[10px] bg-dropdown-background opacity-0 shadow-xl shadow-black/5 transition-all group-hover:pointer-events-auto group-hover:visible group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100 max-sm:fixed max-sm:end-4 max-sm:start-4 max-sm:top-[--header-h] max-sm:w-auto sm:max-md:-end-28 md:before:absolute md:before:-top-1.5 md:before:end-12 md:before:z-9 md:before:size-3.5 md:before:rotate-45 md:before:rounded-sm md:before:bg-dropdown-background">
                                <div class="relative h-full overflow-y-auto py-9">
                                    <figure
                                        class="pointer-events-none absolute -top-5 start-0 z-0 h-full w-full overflow-hidden"
                                        aria-hidden="true"
                                    >
                                        <img
                                            class="w-full"
                                    ...
                                    <div class="flex translate-y-1 items-center gap-3 border-b px-9 pb-7 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                                        <div class="w-2/3 translate-y-2 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-[25ms]">
                                            <h4 class="mb-2 text-3xl/9 font-bold [&_span]:block [&_span]:text-[0.647em] [&_span]:opacity-50">
                                                {!! __('<span>Start your</span> Free Trial') !!}
                                            </h4>
                                            <p
                                                class="m-0 w-10/12 translate-y-2 text-xs font-medium text-foreground/80 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-[50ms]">
                                                {{ __('Register to access a world where creativity meets cutting-edge technology.') }}
                                            </p>
                                        </div>
                                        <figure
                                            class="w-1/3 translate-y-2 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-[70ms]"
                                            aria-hidden="true"
                                        >
                                            <img
                                                class="motion-translate-y-loop-[-15px] motion-duration-[2.5s] motion-ease-in-out"
                                                width="96"
                                                height="133"
                                                src="{{ custom_theme_url('/assets/img/misc/robot-1.png') }}"
                                                alt="{{ __('Premium Features') }}"
                                            />
                                        </figure>
                                    </div>
                                    ...
                                    <ul
                                        class="flex translate-y-2 flex-col gap-6 p-9 text-xs font-medium opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-[125ms]">
                                            ...
                                            <li class="flex items-center gap-2.5">
                                                ...
                                                >
                                                    <path
                                                        ...
                                                        fill="url(#paint0_linear_132_16)"
                                                    />
                                                </svg>
                                                {{ __($feature['title']) }}
                                                @if ($feature['is_pro'])
                                                    <span class="-my-2 inline-flex items-center rounded-full border px-3 py-2 text-2xs/none">
                                                        <span class="bg-gradient-to-r from-[#3D9BFC] via-[#5F53EB] to-[#70B4AF] bg-clip-text text-transparent">
                                                            {{ __('Pro') }}
                                                        </span>
                                                    </span>
                                                @endif
                                    ...
                                    <p
                                        class="translate-y-2 px-9 text-[12px] font-medium text-heading-foreground/30 opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-[175ms] [&_span]:text-heading-foreground">
                                        {!! __('Seats are limited. <span>Learn more about</span>') !!}
            ...
            <div class="max-lg:py-5">
                <div
                    id="user_chat_area"
                    @class([
                        'chats-wrap group/chats-wrap relative lg:h-screen',
                        'max-md:h-[calc(100vh-10rem)] md:max-lg:h-[75vh] md:grid md:max-lg:grid-flow-col md:max-lg:[grid-template-columns:30%_70%]' => Auth::check(),
                ...
                >
                    <div
                        @class([
                            'chats-sidebar-wrap relative flex h-[inherit] w-full transition-all max-md:absolute max-md:start-0 max-md:top-20 max-md:z-10 max-md:h-0 max-md:overflow-hidden max-md:bg-background lg:fixed lg:start-0 lg:z-10 lg:h-screen lg:w-[405px] lg:flex-wrap lg:bg-background lg:ps-[--sidebar-w] lg:duration-300 max-md:[&.active]:h-[calc(100%-80px)]',
                    ...
                    >
                        ...
                        <div class="chats-sidebar-links mt-auto hidden w-full shrink-0 flex-col items-start gap-y-5 px-7 pb-12 lg:flex">
                            {{-- TODO: add the link to privacy policy page --}}
                            <x-button
